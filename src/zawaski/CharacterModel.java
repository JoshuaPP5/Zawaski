...
public class CharacterModel extends GameEntity{
    ...
    public CharacterModel(int id, String characterName, String ownerUsername) {
    ...
    public CharacterModel(int id, String characterName, String ownerUsername, int hp, int maxHp, int ap, int maxAp, int level, int xp, int gold, List<String> inventoryItems) {
        super(id, characterName);
        this.ownerUsername = ownerUsername;
        this.inventory = new Inventory<>();
 ...
 // Save character data including gold
    ...
    public static List<CharacterModel> loadCharactersByUser(String username) {
        List<CharacterModel> allCharacters = FileController.loadAllCharacters();
    ...
    public static int generateNewId() {
        return FileController.loadAllCharacters().size() + 1;
    }
